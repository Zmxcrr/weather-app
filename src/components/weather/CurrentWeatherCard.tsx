        ...
        <div className="grid grid-cols-[1.5fr_2fr_2fr] p-8 h-full">
            <div className="grid grid-cols-1">
                ...
                <div className="grid-cols-1 mt-3">
                    <div className="flex items-center gap-4 mb-4">
                        <img src={'src/img/icons/sunrise.svg'} className="dark:invert w-[48px] h-[48px]" alt={t.sunrise}/>
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <img src={'src/img/icons/sunset.svg'} className="dark:invert w-[48px] h-[48px]" alt={t.sunset}/>
                        <div>
            ...
            <div className="grid grid-cols-2 grid-rows-2">
                <div className="grid grid-cols-1 place-items-center">
                    <img src={'src/img/icons/humidity.svg'} className="dark:invert" alt={t.humidity}/>
                    <div>
                ...
                <div className="grid grid-cols-1 place-items-center">
                    <img src={'src/img/icons/wind.svg'} className="dark:invert" alt={t.windSpeed}/>
                    <div>
                ...
                <div className="grid grid-cols-1 place-items-center">
                    <img src={'src/img/icons/pressure.svg'} className="dark:invert" alt={t.pressure}/>
                    <div>
                ...
                <div className="grid grid-cols-1 place-items-center">
                    <img src={'src/img/icons/uv.svg'} className="dark:invert" alt={t.uv}/>
                    <div>
